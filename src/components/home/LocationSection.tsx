        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <ScrollReveal variant="fadeLeft">
            <motion.div className="rounded-2xl overflow-hidden h-[400px] shadow-lg" whileHover={{ scale: 1.02 }} transition={{ type: "spring", stiffness: 300 }}>
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1497.542603852809!2d69.26199674606329!3d41.35050164413911!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38ae8d118e2bc4cf%3A0x374c51e289606a41!2sChorvador%20uz!5e0!3m2!1suz!2s!4v1766405927730!5m2!1suz!2s" width="100%" height="100%" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Office Location" />
            </motion.div>
          </ScrollReveal>

          <ScrollReveal variant="fadeRight" delay={0.2}>
            <div className="flex flex-col justify-center h-full space-y-6">
              {[{ icon: MapPin, title: "Manzil", content: t("location.address") }, { icon: Phone, title: "Telefon", content: t("location.phone"), href: "tel: +998712266596" }, { icon: Mail, title: "Email", content: t("location.email"), href: "mailto:chorvador@chorvador.uz" }].map((item, i) => (

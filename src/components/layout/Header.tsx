    ...
    <nav className={cn(
      ...
      <div className="container-main">
        <div className="flex h-16 items-center justify-between">
          ...
          {/* Desktop navigation - centered, hidden on tablet and below */}
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <div className="relative z-[60]" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-2 bg-muted/50 hover:bg-muted border border-border rounded-lg px-3 py-2 transition-all duration-300"
              >
                <img 
            ...
            {/* Contact Button */}
            <Button onClick={scrollToFooter} size="sm">
              {t("nav.contact")}
            </Button>
          </div>
          ...
          <div className="flex lg:hidden items-center gap-2">
            ...
            <div className="relative z-[60]" ref={mobileDropdownRef}>
              <button
                ...
                className="flex items-center gap-1 bg-muted/50 hover:bg-muted border border-border rounded-lg px-2 py-1.5 transition-all duration-300"
              >
                <img 
                  src={currentLang.flag} 
                  alt={currentLang.label} 
                  ...
                  >
                    {languages.map((lang) => (
                      <button
                        ...
                        className={cn(
                          "w-full flex items-center gap-2 px-3 py-2 text-sm transition-colors duration-200",
                          language === lang.code 
                            ? "bg-primary text-primary-foreground" 
                            : "text-foreground hover:bg-muted"
                        )}
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            ...
            >
              <div className="py-4 max-h-[calc(100vh-4rem)] overflow-y-auto">
                <div className="flex flex-col gap-2">
                  ...
                  >
                    <Button className="w-full" onClick={scrollToFooter}>
                      {t("nav.contact")}
                    </Button>
                  </motion.div>
                </div>

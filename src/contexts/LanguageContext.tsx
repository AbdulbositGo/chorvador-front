...
const translations: Record<Language, Record<string, string>> = {
  uz: {
    ...
    "meta.contact.description": "Chorvador.uz bilan bog'laning. Toshkent, g.Toshkent, ul. Axmad Universitet 22. Tel:  +998 71 226 65 96",
    ...
    "contact.address.value": "g.Toshkent, ul. Axmad Universitet 22",
    ...
    "footer.contact.address": "g.Toshkent, ul. Axmad Universitet 22",
